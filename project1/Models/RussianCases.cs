...
{
	internal class RussianCases
	{
		public static string RubPhrase(decimal money)
		{
			return CurPhrase(money, "рубль", "рубля", "рублей", "копейка", "копейки", "копеек");
		}

		public static string GenerateNumEnding(int number, string nominativ, string genetiv, string plural)
		{
